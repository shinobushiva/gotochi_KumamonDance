...
public interface IGotochiService extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
			jag.kumamoto.apps.gotochi.IGotochiService {
		 ...
		 * jag.kumamoto.apps.gotochi.IGotochiService interface, generating a
		 * proxy if needed.
		 */
		public static jag.kumamoto.apps.gotochi.IGotochiService asInterface(
		...
		private static class Proxy implements
			...
			public int getActivityNumber() throws android.os.RemoteException {
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_getActivityNumber, _data,
							_reply, 0);
			...
			public void restart() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote
							.transact(Stub.TRANSACTION_restart, _data, _reply,
									0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public boolean isRunning() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_isRunning, _data, _reply,
							0);
					_reply.readException();
